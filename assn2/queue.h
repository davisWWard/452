...
public:
    ...
    /** Insert a new element before the position passed */
    void insert(Data d, unsigned pos);
...
/** Test function tests the queue and hte insert functions */
void testFunction(Queue);
